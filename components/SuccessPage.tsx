        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="bg-gray-800 border border-gray-700 rounded-3xl p-6 shadow-lg">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4 p-5 bg-green-900/30 border border-green-700 rounded-3xl shadow-lg">
