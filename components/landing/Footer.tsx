...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#163237] text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* Brand & Description */}
          <div>
            <h3 className="text-2xl font-bold mb-4 text-[#fffb7a]">
              Zeneidas Surf Garden
            </h3>
            <p className="text-gray-300 leading-relaxed">
              Transform your life through surf, yoga, and connection with nature in the heart of Costa Rica&apos;s paradise.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-[#fffb7a]">Quick Links</h4>
        ...
        <div className="border-t border-white/10 pt-8 text-center text-gray-400">
          ...
          <p className="mt-2 text-sm">
            Designed with love in Costa Rica
          </p>
        </div>
      </div>
    </footer>
