              ...
              <div className="space-y-6">
                ...
                {error && !isSearching && (
                  <motion.div
                    initial={{ opacity: 0, y: -10 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="flex flex-col gap-4 p-5 rounded-xl bg-red-50 border-2 border-red-300"
                  >
                    ...
                    {/* Contact Information - Always shown when there's an error */}
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-700 mb-3">
                            {locale === 'es'
                              ? 'Si realizó su reserva mediante Booking, Expedia u otro buscador, o si tiene problemas para encontrarla, contáctenos por WhatsApp:'
                              : 'If you made your reservation through Booking, Expedia or another search engine, or if you have trouble finding it, contact us via WhatsApp:'}
                          </p>
                          <a
                            href="https://wa.me/541153695627"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 px-4 py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-lg font-semibold text-sm transition-all shadow-md hover:shadow-lg"
                          >
