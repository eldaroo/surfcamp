...
const translations = {
  es: {
    ...
    activities: {
      ...
      haveReservation: "Ya tengo reserva",
      findReservation: "Buscar mi reserva",
      enterDocument: "Ingresa tu documento",
      documentPlaceholder: "Número de documento",
      searchReservation: "Buscar reserva",
      searching: "Buscando...",
      reservationNotFound: "No se encontró ninguna reserva con este documento",
      reservationFound: "Reserva encontrada",
      addToExistingReservation: "Agregar a reserva existente",
      categories: {
        surf: "Surf",
        yoga: "Yoga",
        ...
        data: [
          {
            ...
            review:
              "La gente, la conexión con la naturaleza, el surf... Encontré en Santa Teresa lo que estaba buscando cuando dejé mi país el año pasado. Me encanta vivir en Zeneidas, se siente como en casa, lo que necesito ahora. Esta experiencia abre mi mente y me permite ser una mejor persona. Estoy muy feliz. ♥️",
          },
          {
            id: 2,
          ...
          },
          {
            ...
            review:
              "Los atardeceres más hermosos, las personas más cálidas y la energía más increíble. Vine aquí sola y me fui con una familia. Cada actividad fue cuidadosamente planificada y los facilitadores realmente se preocupan por tu crecimiento y bienestar. ¡El surf camp superó todas mis expectativas y no puedo esperar para volver!",
          },
        ],
      }
    }
  ...
  en: {
    ...
    activities: {
      ...
      findReservation: "Find my reservation",
      enterDocument: "Enter your ID number",
      documentPlaceholder: "ID number",
      searchReservation: "Search reservation",
      searching: "Searching...",
      reservationNotFound: "No reservation found with this ID number",
      reservationFound: "Reservation found",
      addToExistingReservation: "Add to existing reservation",
      categories: {
        surf: "Surf",
        yoga: "Yoga",
        ice_bath: "Ice Bath",
      ...
      trusted: "Trusted by travelers from 45+ countries",
